...
let properties = [
	...
	['Heading Flag Album View', true, 'revFlagShow'],
	...
	['Summary Popular Now / Latest', true, 'summaryPopLatest'],
	...
	['Text Reader Source 4 Name', 'lyrics', 'nmTxtReader4'],
	['Text Reader Source 5 Name', 'lyrics', 'nmTxtReader5'],
	['Text Reader Source 6 Name', 'lyrics', 'nmTxtReader6'],
	...
	['Text Reader Source 5 (field or full path)', '', 'pthTxtReader4'], // seems OK: doesn't show on change if no entries??  if no alb sourceswant lyr here as def avoid lock showing unwanted menu item / doing unwanted toggles confusing?????? else rework handlers
	['Text Reader Source 6 (field or full path)', '', 'pthTxtReader5'],
	['Text Reader Source 7 (field or full path)', '', 'pthTxtReader6'],
	...
	['Text Reader Source 5 Lyrics', false, 'lyricsTxtReader4'],
	['Text Reader Source 6 Lyrics', false, 'lyricsTxtReader5'],
	['Text Reader Source 7 Lyrics', false, 'lyricsTxtReader6'],
	['Text Reader Source 8 Lyrics', false, 'lyricsTxtReader7'],
	['Text Reader Synchronise With Lyrics Download', false, 'syncTxtReaderLyrics'],
	['Text Reader Lyrics Speed', 500, 'lyricsTxtReaderSpeed'],
...
// ALL auto mode code removed txt.text rework needs checking
// ppt.imgText = true; // auto mode no longer available: incompatible with newer features [all code still in place but with menu option hidden: now removed see above]